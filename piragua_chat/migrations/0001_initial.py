    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Human', 'Human'), ('AI', 'AI')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_id', models.DateTimeField(blank=True, max_length=255, null=True)),
                ('messure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='piragua_chat.messure')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='piragua_chat.session')),
            ],
        ),
    ]
