...
from piragua_chat.services.monitored_sources_service import (
    get_monitored_water_sources,
)

get_monitored_water_sources_tool = StructuredTool.from_function(
    func=get_monitored_water_sources,
    name="fuentes_hidricas_monitoreadas_municipio",
