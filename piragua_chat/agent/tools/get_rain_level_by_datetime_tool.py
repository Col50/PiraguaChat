...
from piragua_chat.services.meteorological_station_service import (
    get_rain_level_by_datetime,
)


get_rain_level_by_datetime_tool = StructuredTool.from_function(
    func=get_rain_level_by_datetime,
    name="consultar_nivel_lluvia_por_fecha_hora",
